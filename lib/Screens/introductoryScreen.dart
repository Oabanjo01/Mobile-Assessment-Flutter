...
class IntroductoryPage extends StatefulWidget {
  const IntroductoryPage({Key? key, this.title}) : super(key: key);
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Button(buttonText: 'Personal', buttonHeight: 0.2, butttonWidth: 0.7, routename: '/signup', labelTexts: personal, curve: 30,),
                SizedBox(height: size.height * 0.1,),
                Button(buttonText: 'E-Commerce', buttonHeight: 0.2, butttonWidth: 0.7, routename: '/signup', labelTexts: ecommerce, curve: 30)
                // Button(
